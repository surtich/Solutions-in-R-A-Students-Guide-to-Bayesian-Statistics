...
tibble(posterior_predictive) |> ggplot() +
  ...
  geom_point(data=tibble(X=X_total), aes(x=X, y=0), color="blue") +
  geom_jitter(data=tibble(posterior_predictive) |> slice_sample(n=50), aes(x=posterior_predictive, y=10), color="red", width=0,height=8) +
